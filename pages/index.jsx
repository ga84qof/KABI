...
export default function Home({ listings }) {
  return (
    <>
      <Head><title>{process.env.NEXT_PUBLIC_SITE_NAME || 'Kabi'} – Find storage</title></Head>
      ...
      <div style={{display:'grid', gridTemplateColumns:'repeat(auto-fill, minmax(260px, 1fr))', gap:16}}>
        ...
        {listings.length === 0 && <div style={{color:'#666'}}>No listings found. Did you import seeds into Supabase?</div>}
      </div>
    </>
  );
}
